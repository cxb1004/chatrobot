...
class ServiceLog:
    ...
    def __init__(self):
        _config = Config()
        flask_logger_name = _config.get_value('flask-log', 'flask_logger_schedule_job')
        ...
        flask_logger_logfile = _config.get_value('flask-log', 'flask_logger_schedule_job_logfile')
        ...
        ServiceLog.__flask_log.addHandler(__fileByDateHandle)

    @staticmethod
    def info(msg):
        ServiceLog.__flask_log.info(msg)

    @staticmethod
    def debug(msg):
        ServiceLog.__flask_log.debug(msg)

    @staticmethod
    def warn(msg):
        ServiceLog.__flask_log.warning(msg)

    @staticmethod
    def error(msg):
        ServiceLog.__flask_log.error(msg)

    @staticmethod
    def error_ex(msg):
        ServiceLog.__flask_log.exception(msg, exc_info=True)
