...
class TrainLog:
    ...
    def __init__(self):
        _config = Config()
        flask_logger_name = _config.get_value('flask-log', 'flask_logger_trian')
        ...
        flask_logger_logfile = _config.get_value('flask-log', 'flask_logger_train_logfile')
        ...
        TrainLog.__flask_log.addHandler(__fileByDateHandle)

    @staticmethod
    def info(msg):
        TrainLog.__flask_log.info(msg)

    @staticmethod
    def debug(msg):
        TrainLog.__flask_log.debug(msg)

    @staticmethod
    def warn(msg):
        TrainLog.__flask_log.warning(msg)

    @staticmethod
    def error(msg):
        TrainLog.__flask_log.error(msg)

    @staticmethod
    def error_ex(msg):
        TrainLog.__flask_log.exception(msg, exc_info=True)
